...
{
    public partial class Agregar_preguntas : System.Web.UI.Page
    {
        ...
        //string s = ConfigurationManager.ConnectionStrings["onlineexam"].ConnectionString; //string of connection
        ...
        protected void btn_addexam_Click(object sender, EventArgs e)
        {
            ...
            //            if (i > 0)
            //            {
            //                Response.Redirect("~/Views/admin/exam.aspx");
            //            }
            //            else
            //            {
            //                txt_examname.Focus();
