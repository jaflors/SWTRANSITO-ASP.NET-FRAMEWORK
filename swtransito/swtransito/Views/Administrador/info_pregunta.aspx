<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Administrador/Administrador.Master" AutoEventWireup="true" CodeBehind="info_pregunta.aspx.cs" Inherits="swtransito.Views.Administrador.info_pregunta" %>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <asp:TextBox ID="txt_questionname" runat="server" TextMode="MultiLine" CssClass="form-control" Height="150px" Enabled="false"></asp:TextBox>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <asp:TextBox ID="txt_optionone" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <asp:TextBox ID="txt_optiontwo" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <asp:TextBox ID="txt_optionfourt" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                            <%--<asp:RequiredFieldValidator ID="require_op4" runat="server" ErrorMessage="Enter option four" ControlToValidate="txt_optionfour" ForeColor="red"></asp:RequiredFieldValidator>--%>
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <asp:TextBox ID="rdo_correctanswer" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                            <%--<asp:RequiredFieldValidator ID="require_op4" runat="server" ErrorMessage="Enter option four" ControlToValidate="txt_optionfour" ForeColor="red"></asp:RequiredFieldValidator>--%>
                        </div>
                    </div>
